...
ScintillatingTracker::ScintillatingTracker(const G4String& name)
: G4VSensitiveDetector(name), totalE(0.), total_xTimesE(0.), total_yTimesE(0.)
{}


void ScintillatingTracker::Initialize(G4HCofThisEvent* /*HCE*/)
{
...
G4bool ScintillatingTracker::ProcessHits(G4Step* step, G4TouchableHistory*) {
